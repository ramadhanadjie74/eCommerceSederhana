			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<section class="lattest-product-area pb-40 category-list">
					<div class="row">
						<!-- single product -->
						<?php
						$ambil=$koneksi->query("SELECT * FROM produk WHERE kategoriproduk='Ikan Konsumsi'");
								...
								<div class="single-product">
									...
									<div class="product-details">
										...
										<div class="prd-bottom">
											<a href="#" class="social-info"><span class="ti-bag"></span><p class="hover-text">Bungkus</p></a>
