...
$ambil=$koneksi->query("SELECT * FROM promo WHERE idproduk='$idpr'");
			...
			<div class="row s_product_inner">
				...
				<div class="col-lg-5 offset-lg-1">
					...
					<font color="orange" size="5">
						<strong>Rp. <?php echo number_format($detail['hargadiskon']); ?></strong>
					</font>
					<s><font color="grey" size="2">
						<strong>Rp. <?php echo number_format($detail['harganormal']); ?></strong><br><br>
					</font></s>
					...
					<form method="POST">
						...
						<div class="card_area d-flex align-items-center">
							<a class="primary-btn" name="beli"><font color="black">Masukkan Keranjang</font></a>
						</div>
					</form>
			...
			<div class="tab-content" id="myTabContent">
				...
				<div class="tab-pane fade show active" id="contact" role="tabpanel" aria-labelledby="contact-tab">
					<div class="row">
						<?php
						$idpr=$idpr;
						$ambil=$koneksi->query("SELECT * FROM ulasan WHERE idproduk='$idpr'");
