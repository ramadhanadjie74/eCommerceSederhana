...
$kid=$_GET[id];
$ambil=$koneksi->query("SELECT * FROM kurir WHERE idkurir='$kid'");
$kurir=$ambil->fetch_assoc();
?>
			...
			<div class="form-panel">
				<form method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="nama" class="form-control" value="<?php echo $kurir['namakurir']; ?>" required>
						</div>
					</div><br><br><br>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="number" name="telefon" class="form-control" value="<?php echo $kurir['telefonkurir']; ?>" required>
						</div>
					</div><br><br>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="email" name="email" class="form-control" value="<?php echo $kurir['emailkurir']; ?>" required>
						</div>
					</div><br><br>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea type="text" name="alamat" class="form-control" required><?php echo $kurir['alamatkurir']; ?></textarea>
						</div>
					</div><br><br><hr>

					<div align="right">
						<a href="media.php?halaman=dkurir" class="btn btn-theme"><i class="fa fa-arrow-left"></i> Kembali
						</a>
...
if (isset($_POST['save']))
{
	...
	$kued=$_GET["id"];
	$log="Mengubah Data Kurir dengan ID: $kued";

	$now=date("Y-m-d H:i:s");

	$koneksi->query("UPDATE produk SET namakurir='$nama', telefonkurir='$telefon', emailkurir='$email', alamatkurir='$alamat' WHERE idkurir='$kid'");
