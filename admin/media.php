...
<!--   <?php echo $admin["id"]; ?> -->
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="media.php?halaman=home" class="logo"><b>Exotic <span>Fish</span></b>
      </a>
      <!--logo end-->
      ...
      <div class="nav notify-row" id="top_menu">
        ...
        <ul class="nav top-menu">
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="media.php?halaman=home">
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <p>
          &copy;Mutiara Botol. All Rights Reserved
          </font>
        </p>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      var unique_id = $.gritter.add({
        ...
        title: 'Mutiara Botol Administration Panel!',
